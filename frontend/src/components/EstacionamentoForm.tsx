...
export function EstacionamentoForm({ onClose, onSuccess }: EstacionamentoFormProps) {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Ex: EasyPark" />

          <label>Endereço</label>
          <input type="text" value={endereco} onChange={(e) => setEndereco(e.target.value)} placeholder="Ex: AV. 123, numero 23" />

          <label>Capacidade</label>
          <input type="number" value={totalVagas} onChange={(e) => setTotalVagas(e.target.value)} placeholder="Ex: 123" />

          <label>Valor por Primeira Hora (R$)</label>
          <input type="number" step="0.01" value={valorPrimeiraHora} onChange={(e) => setValorPrimeiraHora(e.target.value)} placeholder="Ex: 15.00" />
          
          <label>Valor por Demais Horas (R$)</label>
          <input type="number" step="0.01" value={valorDemaisHoras} onChange={(e) => setValorDemaisHoras(e.target.value)} placeholder="Ex: 5.00" />

          <label>Valor da Diária (R$)</label>
          <input type="number" step="0.01" value={valorDiaria} onChange={(e) => setValorDiaria(e.target.value)} placeholder="Ex: 35.00" />
